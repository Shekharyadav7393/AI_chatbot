    ...
    <div className="p-6 md:p-8 max-w-6xl mx-auto w-full">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-400">Manage your uploaded knowledge base documents</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24 bg-slate-800/30 rounded-2xl border border-slate-700/50 border-dashed">
          ...
          <p className="text-slate-500 max-w-sm mx-auto">
            Upload PDF, DOCX, or TXT files to build your knowledge base and start chatting with your data.
          </p>
        </div>
      ) : (
